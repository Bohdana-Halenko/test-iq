...
// Отображение страницы после клика на Далее
...
questionsItems.innerHTML = `
  <img class="end__img" src="images/load.svg" alt="загрузка">
...
function endTest () {
  ...
  testingWrapper.innerHTML = `
    ...
    <a class="end-page__link" href="tel:+380680000000">Позвонить и прослушать
      результат</a>`

  const declaration = document.createElement('div')
  declaration.classList = 'declaration'
  declaration.innerHTML = 'TERMENI SI CONDITII: ACESTA ESTE UN SERVICIU DE DIVERTISMENT. PRIN FOLOSIREA LUI DECLARATI CA AVETI 18 ANI IMPLINITI'
...
const test = () => {
  ...
  const test2 = (name, height, weight, eyes, color) => {
    ...
    <h3 class="data__title">Поздравляю ${name}</h3>
    <ul class="data__list">
